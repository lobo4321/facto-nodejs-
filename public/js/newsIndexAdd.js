...
const JUM = {
  ...
  newsContainer: document.querySelector('#data-news-index'),

  addNewsIndex(newsIndex, index){

      let div = document.createElement('div')
      div.classList.add('col-lg-4')
      div.classList.add('col-md-4')
      div.classList.add('col-sm-12')
      div.innerHTML = JUM.innerHTMLNews(newsIndex)

      JUM.newsContainer.appendChild(div);
  },

  innerHTMLNews(newsIndex){
      const html = 
      `
      <div class="articles_grid_style">
        <div class="articles_grid_thumb">
          <a
            ...
            height: 250px; ' src="${newsIndex.img}" class="img-fluid" alt=""
          /></a>
        </div>
        ...
        <div class="articles_grid_caption">
          ...
          <div class="articles_grid_author">
            <div class="articles_grid_author_img">
              <img src="${newsIndex.authorimg}" class="img-fluid" alt=""  style='object-fit: cover'/>
            </div>
            <h4>${newsIndex.author}</h4>
          </div>
        </div>
...
news.forEach(function(newsIndex){
  JUM.addNewsIndex(newsIndex)
})